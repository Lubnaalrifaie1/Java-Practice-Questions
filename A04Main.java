...
public class A04Main {
    ...
    public static final String FILENAME = "/Users/adilmohammad/cp213-master/moha5810_a04/decline.txt";
    	...
    	while (fileScan.hasNextLine()) {
    	    ...
    	    for (final Character letter : line.toCharArray()) {
	    		...
	    		if (Character.isLetter(letter)) {
	    		    final CountedItem<Character> key = new CountedItem<Character>(Character.toUpperCase(letter));
	    		    tree.retrieve(key);
	    		}
    	    }
    	}
    ...
    private static void testAVL() {
		...
		System.out.println("  Height {0}: " + source.getHeight());
		System.out.println(LINE);
		System.out.println("Insert values: " + Arrays.toString(testItems));
	
		for (Integer i : testItems) {
			CountedItem<Integer> value = new CountedItem<>(i);
			source.insert(value);
		}
